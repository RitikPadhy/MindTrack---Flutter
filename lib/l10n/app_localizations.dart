...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      // MAUQ Form
      'mauq_form': 'MAUQ Form',
      'switch_to_kannada': 'Switch to Kannada',
      'switch_to_hindi': 'Switch to Hindi',
      'switch_to_malayalam': 'Switch to Malayalam',
      'switch_to_english': 'Switch to English',
      'optional_feedback': 'Optional Feedback',
      'mauq_submitted_success': 'MAUQ submitted successfully!',
      'mauq_already_submitted': 'Feedback was already submitted!',
      'mauq_submit_failed': 'Failed to submit MAUQ:',
      'in_this_questionnaire': 'In this questionnaire:',
      'scale_1': '1 – Strongly disagree',
      'scale_2': '2 – Disagree',
      'scale_3': '3 – Somewhat disagree',
      'scale_4': '4 – Neither agree nor disagree',
      'scale_5': '5 – Somewhat agree',
      'scale_6': '6 – Agree',
      'scale_7': '7 – Strongly agree',
    ...
    'hi': {
      ...
      'switch_to_kannada': 'कन्नड़ में बदलें',
      'switch_to_hindi': 'हिंदी में बदलें',
      'switch_to_malayalam': 'मलयालम में बदलें',
      'switch_to_english': 'अंग्रेजी में बदलें',
      'optional_feedback': 'वैकल्पिक फीडबैक',
      'mauq_submitted_success': 'MAUQ सफलतापूर्वक सबमिट किया गया!',
      'mauq_already_submitted': 'फीडबैक पहले ही सबमिट किया जा चुका है!',
      'mauq_submit_failed': 'MAUQ सबमिट करने में विफल:',
      'in_this_questionnaire': 'इस प्रश्नावली में:',
      'scale_1': '1 – पूरी तरह असहमत',
      'scale_2': '2 – असहमत',
      'scale_3': '3 – थोड़ा असहमत',
      'scale_4': '4 – न सहमत और न ही असहमत',
      'scale_5': '5 – थोड़ा सहमत',
      'scale_6': '6 – सहमत',
      'scale_7': '7 – पूरी तरह सहमत',
      ...
      'mauq_q7': 'जानकारी अच्छी तरह व्यवस्थित थी।',
      'mauq_q8': 'ऐप ने प्रगति को पर्याप्त रूप से स्वीकार किया।',
      'mauq_q9': 'मैं सामाजिक सेटिंग में इस ऐप का उपयोग करने में सहज महसूस करता हूं।',
      'mauq_q10': 'ऐप का उपयोग करने में लगने वाला समय उपयुक्त था।',
      'mauq_q11': 'मैं इस ऐप का फिर से उपयोग करूंगा।',
    ...
    'kn': {
      ...
      'switch_to_kannada': 'ಕನ್ನಡಕ್ಕೆ ಬದಲಿಸಿ',
      'switch_to_hindi': 'ಹಿಂದಿಗೆ ಬದಲಿಸಿ',
      'switch_to_malayalam': 'ಮಲಯಾಳಂಗೆ ಬದಲಿಸಿ',
      'switch_to_english': 'ಇಂಗ್ಲಿಷ್‌ಗೆ ಬದಲಿಸಿ',
      'optional_feedback': 'ಐಚ್ಛಿಕ ಪ್ರತಿಕ್ರಿಯೆ',
      'mauq_submitted_success': 'MAUQ ಯಶಸ್ವಿಯಾಗಿ ಸಲ್ಲಿಕೆಯಾಗಿದೆ!',
      'mauq_already_submitted': 'ಪ್ರತಿಕ್ರಿಯೆಯನ್ನು ಈಗಾಗಲೇ ಸಲ್ಲಿಸಲಾಗಿದೆ!',
      'mauq_submit_failed': 'MAUQ ಸಲ್ಲಿಸಲು ವಿಫಲವಾಗಿದೆ:',
      'in_this_questionnaire': 'ಈ ಪ್ರಶ್ನಾವಳಿಯಲ್ಲಿ:',
      'scale_1': '1 – ಸಂಪೂರ್ಣವಾಗಿ ಒಪ್ಪುವುದಿಲ್ಲ',
      'scale_2': '2 – ಒಪ್ಪುವುದಿಲ್ಲ',
      'scale_3': '3 – ಸ್ವಲ್ಪ ಮಟ್ಟಿಗೆ ಒಪ್ಪುವುದಿಲ್ಲ',
      'scale_4': '4 – ಒಪ್ಪುತ್ತೇನೆ ಅಥವಾ ಒಪ್ಪುವುದಿಲ್ಲ',
      'scale_5': '5 – ಸ್ವಲ್ಪ ಮಟ್ಟಿಗೆ ಒಪ್ಪುತ್ತೇನೆ',
      'scale_6': '6 – ಒಪ್ಪುತ್ತೇನೆ',
      'scale_7': '7 – ಸಂಪೂರ್ಣವಾಗಿ ಒಪ್ಪುತ್ತೇನೆ',
      ...
      'mauq_q6': 'ನಮಗೆ ಆ್ಯಪ್‌ನ ಇಂಟರ್‌ಫೇಸ್ ಇಷ್ಟವಾಗಿದೆ.',
    ...
    'ml': {
      ...
      // MAUQ Form
      'mauq_form': 'MAUQ ഫോം',
      'switch_to_kannada': 'കന്നഡയിലേക്ക് മാറ്റുക',
      'switch_to_hindi': 'ഹിന്ദിയിലേക്ക് മാറ്റുക',
      'switch_to_malayalam': 'മലയാളത്തിലേക്ക് മാറ്റുക',
      'switch_to_english': 'ഇംഗ്ലീഷിലേക്ക് മാറ്റുക',
      'optional_feedback': 'ഓപ്ഷണൽ ഫീഡ്‌ബാക്ക്',
      'mauq_submitted_success': 'MAUQ വിജയകരമായി സമർപ്പിച്ചു!',
      'mauq_already_submitted': 'ഫീഡ്‌ബാക്ക് ഇതിനകം സമർപ്പിച്ചു!',
      'mauq_submit_failed': 'MAUQ സമർപ്പിക്കുന്നതിൽ പരാജയപ്പെട്ടു:',
      'in_this_questionnaire': 'ഈ ചോദ്യാവലിയിൽ:',
      'scale_1': '1 – ശക്തമായി വിയോജിക്കുന്നു',
      'scale_2': '2 – വിയോജിക്കുന്നു',
      'scale_3': '3 – അല്പം വിയോജിക്കുന്നു',
      'scale_4': '4 – യോജിക്കുകയോ വിയോജിക്കുകയോ ചെയ്യുന്നില്ല',
      'scale_5': '5 – അല്പം യോജിക്കുന്നു',
      'scale_6': '6 – യോജിക്കുന്നു',
      'scale_7': '7 – ശക്തമായി യോജിക്കുന്നു',
      'mauq_q1': 'ആപ്പ് ഉപയോഗിക്കാൻ എളുപ്പമായിരുന്നു.',
      'mauq_q2': 'ആപ്പ് ഉപയോഗിക്കാൻ പഠിക്കുന്നത് എനിക്ക് എളുപ്പമായിരുന്നു.',
      'mauq_q3': 'സ്ക്രീനുകൾക്കിടയിലുള്ള നാവിഗേഷൻ ഏകീകൃതമായിരുന്നു.',
      'mauq_q4': 'വാഗ്ദാനം ചെയ്ത എല്ലാ ഫംഗ്ഷനുകളും ഉപയോഗിക്കാൻ ഇന്റർഫേസ് എന്നെ അനുവദിച്ചു.',
      'mauq_q5': 'തെറ്റുകളിൽ നിന്ന് എനിക്ക് എളുപ്പത്തിൽ കരകയറാൻ കഴിഞ്ഞു.',
      'mauq_q6': 'എനിക്ക് ആപ്പിന്റെ ഇന്റർഫേസ് ഇഷ്ടമാണ്.',
      'mauq_q7': 'വിവരങ്ങൾ നന്നായി ക്രമീകരിച്ചിരിക്കുന്നു.',
      'mauq_q8': 'ആപ്പ് പുരോഗതി വേണ്ടവിധം അംഗീകരിച്ചു.',
      'mauq_q9': 'സാമൂഹിക സാഹചര്യങ്ങളിൽ ഈ ആപ്പ് ഉപയോഗിക്കുന്നതിൽ എനിക്ക് സുഖം തോന്നുന്നു.',
      'mauq_q10': 'ആപ്പ് ഉപയോഗിക്കുന്നതിൽ ഉൾപ്പെട്ട സമയം അനുയോജ്യമായിരുന്നു.',
      'mauq_q11': 'ഞാൻ ഈ ആപ്പ് വീണ്ടും ഉപയോഗിക്കും.',
      'mauq_q12': 'മൊത്തത്തിൽ, ഈ ആപ്പിൽ ഞാൻ സംതൃപ്തനാണ്.',
      'mauq_q13': 'എന്റെ ആരോഗ്യത്തിനും ക്ഷേമത്തിനും ആപ്പ് ഉപയോഗപ്രദമാണ്.',
      ...
      'mauq_q16': 'ഈ ആപ്പിന് പ്രതീക്ഷിച്ച എല്ലാ ഫംഗ്ഷനുകളും കഴിവുകളും ഉണ്ട്.',
      'mauq_q17': 'മോശം ഇന്റർനെറ്റ് കണക്ഷനിൽ പോലും എനിക്ക് ആപ്പ് ഉപയോഗിക്കാൻ കഴിഞ്ഞു.',
      'mauq_q18': 'ആരോഗ്യ സേവനങ്ങൾ സ്വീകരിക്കുന്നതിന് ആപ്പ് സ്വീകാര്യമായ ഒരു മാർഗം നൽകുന്നു.',
    },
  };
  ...
  String translateWithCode(String key, String code) {
